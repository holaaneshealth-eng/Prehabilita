...
<ul><li><strong>Resistencia aeróbica:</strong> caminar es la base. Mejora tu corazón y tus pulmones.</li>
<li><strong>Fuerza:</strong> con tu propio peso o resistencia ligera (bandas, botellas o mancuernas pequeñas). Preserva la masa muscular y tu funcionalidad.</li>
<li><strong>Flexibilidad:</strong> estiramientos suaves para mantener la movilidad y reducir la rigidez, sin buscar dolor ni rangos máximos.</li></ul>
...
<ul><li><strong>Aerobic endurance:</strong> walking is the foundation. It improves your heart and lungs.</li>
<li><strong>Strength:</strong> using your own body weight or light resistance (bands, bottles or small dumbbells). It preserves muscle mass and function.</li>
<li><strong>Flexibility:</strong> gentle stretching to keep mobility and reduce stiffness, never pushing into pain or maximum ranges.</li></ul>
...
<ul><li><strong>Resistència aeròbica:</strong> caminar és la base. Millora el cor i els pulmons.</li>
<li><strong>Força:</strong> amb el teu propi pes o resistència lleugera (bandes, ampolles o manuelles petites). Preserva la massa muscular i la funcionalitat.</li>
<li><strong>Flexibilitat:</strong> estiraments suaus per mantenir la mobilitat i reduir la rigidesa, sense buscar dolor ni rangs màxims.</li></ul>
...
<h4>Tu semana</h4>
<ul><li><strong>Frecuencia:</strong> 5-7 días.</li>
<li><strong>Duración:</strong> 30-45 min al día.</li>
...
<h4>Your week</h4>
<ul><li><strong>Frequency:</strong> 5-7 days.</li>
<li><strong>Duration:</strong> 30-45 min a day.</li>
...
<ul><li><strong>Freqüència:</strong> 5-7 dies.</li>
<li><strong>Durada:</strong> 30-45 min al dia.</li>
...
<h4>Tu semana</h4>
<ul><li><strong>Frecuencia:</strong> 3-5 días.</li>
<li><strong>Duración:</strong> 45-60 min.</li>
...
<li><strong>Fuerza (20-25 min):</strong> prensa o sentadilla asistida, remo sentado y press de pecho (2-3 series de 8-12). Si tienes experiencia y no hay contraindicaciones, bisagra de cadera o peso muerto muy ligero. Añade trabajo de core suave y control postural.</li>
<li><strong>Flexibilidad y vuelta a la calma (5-10 min):</strong> caminar suave, estiramientos de los grupos musculares trabajados (mantén cada uno 20-30 s, sin dolor) y respiración diafragmática.</li></ul>`,
...
<h4>Your week</h4>
<ul><li><strong>Frequency:</strong> 3-5 days.</li>
<li><strong>Duration:</strong> 45-60 min.</li>
...
<li><strong>Strength (20-25 min):</strong> leg press or assisted squat, seated row and chest press (2-3 sets of 8-12). If experienced and with no contraindications, hip hinge or very light deadlift. Add gentle core work and postural control.</li>
<li><strong>Flexibility and cool-down (5-10 min):</strong> gentle walking, stretches for the muscle groups you worked (hold each for 20-30 s, no pain) and diaphragmatic breathing.</li></ul>`,
...
<h4>La teva setmana</h4>
<ul><li><strong>Freqüència:</strong> 3-5 dies.</li>
<li><strong>Durada:</strong> 45-60 min.</li>
...
<li><strong>Força (20-25 min):</strong> premsa o sentadilla assistida, rem assegut i press de pit (2-3 sèries de 8-12). Si tens experiència i no hi ha contraindicacions, frontissa de maluc o pes mort molt lleuger. Afegeix treball de core suau i control postural.</li>
<li><strong>Flexibilitat i tornada a la calma (5-10 min):</strong> caminar suau, estiraments dels grups musculars treballats (mantén cadascun 20-30 s, sense dolor) i respiració diafragmàtica.</li></ul>`,
    },
    {
