...
<h4>Principios</h4>
<ul><li><strong>Empieza pronto</strong> y sé constante: la regularidad importa más que la intensidad.</li>
<li><strong>Progresivo y seguro</strong>: sube poco a poco, cuidando la técnica.</li>
<li>El objetivo no es "ponerte en forma" en semanas, sino llegar con <strong>mejor tolerancia al esfuerzo</strong>.</li>
...
<h4>Principles</h4>
<ul><li><strong>Start early</strong> and be consistent: regularity matters more than intensity.</li>
<li><strong>Progressive and safe</strong>: build up gradually, with good technique.</li>
<li>The goal is not to "get fit" in a few weeks, but to arrive with <strong>better exercise tolerance</strong>.</li>
...
<h4>Principis</h4>
<ul><li><strong>Comença aviat</strong> i sigues constant: la regularitat importa més que la intensitat.</li>
<li><strong>Progressiu i segur</strong>: puja a poc a poc, cuidant la tècnica.</li>
<li>L'objectiu no és "posar-te en forma" en setmanes, sinó arribar amb <strong>millor tolerància a l'esforç</strong>.</li>
...
<li><strong>Aeróbico (15-20 min):</strong> caminar a ritmo ligero-moderado. Si estás muy desentrenado, empieza con bloques de 5-6 min y descansa entre ellos.</li>
...
<li><strong>Aerobic (15-20 min):</strong> walk at a light-to-moderate pace. If very deconditioned, start with 5-6 min blocks and rest in between.</li>
...
<li><strong>Aeròbic (15-20 min):</strong> camina a ritme lleuger-moderat. Si estàs molt desentrenat, comença amb blocs de 5-6 min i descansa entremig.</li>
...
<li><strong>Vuelta a la calma (5 min):</strong> caminar suave, respiración diafragmática y estiramientos.</li></ul>`,
...
<li><strong>Cool-down (5 min):</strong> gentle walking, diaphragmatic breathing and light stretching.</li></ul>`,
...
<li><strong>Tornada a la calma (5 min):</strong> caminar suau, respiració diafragmàtica i estiraments.</li></ul>`,
    },
    {
